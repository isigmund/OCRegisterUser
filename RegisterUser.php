...
<!--[if !IE]><!--><html class="ng-csp" data-placeholder-focus="false" lang="de" ><!--<![endif]-->
...
<form method="post" action="dump_form_data.php" name="login">
	<fieldset>
		...
		<p class="grouptop">
			<input type="text" name="r" id="newuserfullname"
		...
		<p class="groupbottom">
			<input type="text" name="e" id="newuseremail" value=""
					    style="width: 255px; padding-left: 36px"
				placeholder="eMail"
		        autocomplete="on" autocapitalize="off" autocorrect="off" required />
		...
		<p class="grouptop">
			<input type="text" name="u" id="newusername" value=""
					    style="width: 255px; padding-left: 36px"
		...
		<p class="groupbottom">
			<input type="password" name="p" id="newuserpassword" value=""
					    style="width: 255px; padding-left: 36px"
...
<ul>
    <li class="error">Datei nicht gefunden
        ...
        <p class="hint">
            <a href="/index.php">Du kannst zur Rückkehr zu OwndCloud hier klicken.
            </a>
        </p>
    </li>
</ul>
